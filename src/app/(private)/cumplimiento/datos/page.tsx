...
export default function Page() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="luris-display text-3xl font-bold text-primary">Politica de manejo de datos</h1>
        <p className="mt-1 text-sm text-muted-foreground">Lineamientos iniciales para retencion, acceso, auditoria, organizacion y documentos.</p>
      </div>
      <Card>
