...
export default function Page() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="luris-display text-3xl font-bold text-primary">Terminos de uso</h1>
        <p className="mt-1 text-sm text-muted-foreground">Documento base para condiciones de uso del SaaS y responsabilidades del despacho.</p>
      </div>
      <Card>
