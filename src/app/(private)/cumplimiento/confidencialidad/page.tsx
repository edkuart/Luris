...
export default function Page() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="luris-display text-3xl font-bold text-primary">Acuerdo de confidencialidad</h1>
        <p className="mt-1 text-sm text-muted-foreground">Documento base para usuarios internos, secretarias, abogados asociados y administradores.</p>
      </div>
      <Card>
