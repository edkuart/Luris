...
export default function Page() {
  return (
    <div className="space-y-5">
      <div>
        <h1 className="luris-display text-3xl font-bold text-primary">Politica de privacidad</h1>
        <p className="mt-1 text-sm text-muted-foreground">Documento base para tratamiento de datos personales, expedientes y accesos internos.</p>
      </div>
      <Card>
